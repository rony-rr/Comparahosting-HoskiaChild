...
jQuery(document).ready(function() {
    ...
    function scrollable_stickyBlog_sidebar(){
            
      jQuery('aside.page--sidebar.col-md-3').stickySidebar({
          topSpacing: 0,
          bottomSpacing: 10,
          containerSelector: '#pageContent .container .row'
      });     
    ...
    if( jQuery('body.post-template-default.single.single-post').length ){
        ...
        jQuery('#pageContent .container .row').css({'position': 'relative'});
        scrollable_stickyBlog_sidebar();
        // console.log('sirve');
