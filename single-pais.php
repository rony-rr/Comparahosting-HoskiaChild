...
$category_current = '';
$category_current_slug = '';
$idPOST = get_the_ID();
$extension_de_dominio = get_field( "extension_de_pais", $idPOST );
...
if(isset($_GET['ps'])){
    ...
    $countryPost = $_GET['ps'];
    $extension_de_dominio = get_field( "extension_de_pais", $countryPost );
...
<div id="pageContent" class="pd--100-0">
    ...
    <div class="pricing--filter toggle-btn-content">
                    <ul class="selector-changue-mode-view">
                        ...
                        <li id="compare-toggle-btn" class="compare-card hide-filters"><a href="#pricingTabanual" role="tab" data-toggle="tab">Comparativa</a></li>			
                    </ul>
		        </div>
        <div class="row page--container">
                            ...
                            foreach($category as $po){
                                ...
                                echo '
                                        <li id="'. $id_slug .'" term_id="'. $identity_current_term .'" class="'. $clase_adicional_de_cat .'">
                                            ...
                                            <a href="'.get_category_link($id).'?ps='.$idPOST.'" >'.$po->name.'</a>
                                        </li>
                                    ';
                            }
                            ?>
                            ...
                            <ul>
                                ...
                                <?php 
                                    foreach($metodos_pago as $key => $value){
                                        echo '
                                            <li><input type="checkbox" value="'.$key.'" name="pay[]"> <label>'.$value.'</label></li>
                                        ';
                                    }
                                ?>
            ...
            <article id="container-results-filterpage" class="page--main-content col-md-9 custom-pages">
                ...
                <div id="build-by-term-find">
                    ...
                    <?php get_proveedores_and_plans_by_term($current_taxonomy, $category_current_slug, $category_current, 2, $idPOST, '', '', '', ''); ?>
                </div>
            ...
            <aside class="sidebar--down page--sidebar col-md-12">
              <p id="extension_de_dominio" style="display: none; "><?php echo $extension_de_dominio; ?></p>
            </aside>
