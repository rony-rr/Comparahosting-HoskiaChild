<?php
/**
 * Template Name: Hosting Archive
 * Description: Hosting Archive 
 */
...
<div id="pageContent" class="pd--100-0">
    ...
    <div class="pricing--filter toggle-btn-content">
                    <ul class="selector-changue-mode-view">
                        ...
                        <li id="compare-toggle-btn" style="" class="compare-card hide-filters"><a href="#pricingTabanual" role="tab" data-toggle="tab">Comparativa</a></li>			
                    </ul>
		        </div>
